...
void Compass::getCompassInfo(CompassInfo& compassInfo)
{
  long x = micros();
  ...
  compassInfo.XAxis = norm.XAxis;
  compassInfo.YAxis = norm.YAxis;
  compassInfo.ZAxis = norm.ZAxis;
  compassInfo.headingDegrees = headingDegrees;
  compassInfo.fixedHeadingDegrees = fixedHeadingDegrees;
  compassInfo.smoothHeadingDegrees = smoothHeadingDegrees;
